        ...
        <aside class="w-72 sidebar-gradient text-white">
            ...
            <nav class="p-6">
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="bids.php" class="menu-item active flex items-center gap-3 px-6 py-4 rounded-xl text-white">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200">
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600">Bid ID</th>
                                ...
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600">Bid Amount</th>
                                <th class="px-4 py-3 text-left text-sm font-semibold text-gray-600">Bid Time</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if (!empty($bids)): ?>
                                <?php foreach ($bids as $bid): ?>
                                    <tr class="border-b border-gray-100 hover:bg-gray-50/50">
                                        <td class="px-4 py-3"><?php echo htmlspecialchars($bid['bid_id']); ?></td>
                                        <td class="px-4 py-3"><?php echo htmlspecialchars($bid['auction_id']); ?></td>
                                        <td class="px-4 py-3 font-medium text-indigo-600"><?php echo htmlspecialchars($bid['user_name']); ?></td>
                                        <td class="px-4 py-3 font-medium">Rs. <?php echo number_format($bid['bid_amount'], 2); ?></td>
                                        <td class="px-4 py-3 text-gray-500"><?php echo date('M d, Y H:i', strtotime($bid['bid_time'])); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="px-4 py-3 text-center text-gray-500">No bids found.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
